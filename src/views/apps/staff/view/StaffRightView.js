...
const StaffRightView = ({ tab, invoiceData }) => {
  // ** State
  ...
  const handleChange = (event, value) => {
    ...
    router
      .push({
        pathname: `/apps/staff/view/${value.toLowerCase()}`
      })
  ...
  return (
    <TabContext value={activeTab}>
      ...
      >
        <Tab value='info' label='Info' icon={<Icon fontSize='1.125rem' icon='tabler:user-check' />} />
        ...
        {isLoading ? (
          ...
          <>
            <TabPanel sx={{ p: 0 }} value='info'>
              <StaffInfo invoiceData={invoiceData} />
            </TabPanel>
