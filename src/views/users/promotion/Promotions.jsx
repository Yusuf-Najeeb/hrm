...
const Promotions = () => {
  ...
  return (
    ...
    >
          ...
          <Table stickyHeader>
            <TableHead>
              <TableRow>
                ...
                <TableCell align={'left'}>Previous Position</TableCell>
                <TableCell align={'left'}>New Position</TableCell>
      ...
      <AddPromotion open={modal} close={toggleModal} updateFetch={updateFetch} />
    </Card>
  )
}
