...
import { terminationSchema } from 'src/@core/FormSchema'
...
const CreateTermination = ({ open, close, updateFetch }) => {
    ...
    <Fragment>
      <Dialog open={open} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 550 } }}>
        ...
        >
          ...
          >
            <Typography sx={{ textAlign: 'left', fontSize: '1.25rem', my: 4 }}>Termination</Typography>
